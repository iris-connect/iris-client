...
export const IrisClientFrontendApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        dataRequestsGet: async (options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        dataRequestsPost: async (dataRequestClient: DataRequestClient, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'dataRequestClient' is not null or undefined
            assertParamExists('dataRequestsPost', 'dataRequestClient', dataRequestClient)
            const localVarPath = `/data-requests`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const IrisClientFrontendApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async dataRequestsGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExistingDataRequestClientWithLocation>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.dataRequestsGet(options);
         ...
         * @throws {RequiredError}
         */
        async dataRequestsPost(dataRequestClient: DataRequestClient, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.dataRequestsPost(dataRequestClient, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const IrisClientFrontendApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        dataRequestsGet(options?: any): AxiosPromise<ExistingDataRequestClientWithLocation> {
            return localVarFp.dataRequestsGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Submits a new data request
         ...
         * @throws {RequiredError}
         */
        dataRequestsPost(dataRequestClient: DataRequestClient, options?: any): AxiosPromise<void> {
            return localVarFp.dataRequestsPost(dataRequestClient, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} searchKeyword The search keyword
...
export class IrisClientFrontendApi extends BaseAPI {
     ...
     */
    public dataRequestsGet(options?: any) {
        return IrisClientFrontendApiFp(this.configuration).dataRequestsGet(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof IrisClientFrontendApi
     */
    public dataRequestsPost(dataRequestClient: DataRequestClient, options?: any) {
        return IrisClientFrontendApiFp(this.configuration).dataRequestsPost(dataRequestClient, options).then((request) => request(this.axios, this.basePath));
    }
