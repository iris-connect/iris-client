...
import iris.client_bff.data_submission.DataSubmissionProcess;
 ...
 */
public class EventSubmissionProcess extends DataSubmissionProcess<GuestList> {
  ...
  private @NonNull EventDataSubmissionRepository submissions;
  private @NonNull EventDataRequestService dataRequests;

  public EventSubmissionProcess(DataSubmissionDto submissionDto, EventDataRequest request, KeyStore keyStore,
	  ObjectMapper mapper, @NonNull ModelMapper modelMapper, @NonNull EventDataSubmissionRepository submissions,
  ...
  public void process(GuestList guestList) {
	...
	var submission = new EventDataSubmission(request, guests, dataProvider, guestList.getAdditionalInformation(),
