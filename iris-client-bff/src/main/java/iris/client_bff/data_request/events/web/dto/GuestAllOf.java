...
public class GuestAllOf {
	...
	/**
	 * The app indicates whether the data are verified with respect to identity (e.g. by phone number) = TRUE or whether
	 * they are unverified form inputs = FALSE.
	 * 
	 * @return identityChecked
	 */
	@ApiModelProperty(
			value = "The app indicates whether the data are verified with respect to identity (e.g. by phone number) = TRUE or whether they are unverified form inputs = FALSE.")
