...
public class ExistingDataRequestClientWithLocationList {
	@JsonProperty("dataRequests") @Valid
	private List<ExistingDataRequestClientWithLocation> dataRequests = null;

	public ExistingDataRequestClientWithLocationList dataRequests(
			List<ExistingDataRequestClientWithLocation> dataRequests) {
		this.dataRequests = dataRequests;
		return this;
	}

	public ExistingDataRequestClientWithLocationList addDataRequestsItem(
			ExistingDataRequestClientWithLocation dataRequestsItem) {
