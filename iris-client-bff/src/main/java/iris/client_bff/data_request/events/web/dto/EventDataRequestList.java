...
public class EventDataRequestList {
  @JsonProperty("dataRequests")
  @Valid
  private List<ExistingDataRequestClientWithLocation> dataRequests = null;

  public EventDataRequestList dataRequests(List<ExistingDataRequestClientWithLocation> dataRequests) {
    this.dataRequests = dataRequests;
    return this;
  }

  public EventDataRequestList addDataRequestsItem(ExistingDataRequestClientWithLocation dataRequestsItem) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EventDataRequestList existingDataRequestClientWithLocationList = (EventDataRequestList) o;
