...
public class LocationDataRequest {
	...
	@JsonProperty("start") @org.springframework.format.annotation.DateTimeFormat(
			iso = org.springframework.format.annotation.DateTimeFormat.ISO.DATE_TIME)
	private Instant start;

	@JsonProperty("end") @org.springframework.format.annotation.DateTimeFormat(
			iso = org.springframework.format.annotation.DateTimeFormat.ISO.DATE_TIME)
	private Instant end;
	 ...
	 */
	@ApiModelProperty(example = "https://iris.inoeg.de/api/data-submissions/{code}/guests", required = true,
			value = "The URI that can be used to submit contact data for this tracing code.")
	@NotNull
	 ...
	 * @return locationId
	 */
	@ApiModelProperty(example = "35b7df90-8670-409a-9375-15a56fd995c1", required = true,
			value = "The id of the location.")
	@NotNull
	...
	@ApiModelProperty(required = true,
			value = "The key of the requesting health department that must be used for encryption. The key is encoded with Base64.")
	@NotNull
	 ...
	 */
	@ApiModelProperty(required = true,
			value = "Reference id of the given key. This reference must be included in the submission in order to identify the correct private key for decryption at the health department.")
	@NotNull
	 ...
	 */
	@ApiModelProperty(
			value = "Details of the data request, specifying it in more detail and narrowing down the data to be provided (e.g. table and environment, seat, rank, ...).")
	...
	@Override
	public int hashCode() {
		return Objects.hash(submissionUri, locationId, healthDepartment, keyOfHealthDepartment, keyReference, start, end,
				requestDetails);
	}
