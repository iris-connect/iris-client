...
public class AppStatusResolver {
    ...
    private static final AppStatus STATUS_OK = new AppStatus(AppStatus.Status.OK, "Die Status Prüfung für diesen App Anbieter war erfolgreich.");
    ...
    private static final AppStatus PERMISSION_DENIED_PING_CLIENT_STATUS = new AppStatus(AppStatus.Status.WARNING, "Die Status Anfrage für diesen App Anbieter wurde abgelehnt oder ist derzeit nicht möglich.");
