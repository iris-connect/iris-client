...
public class IrisMessageTransferDefuse {
	...
	private IrisMessageTransferDto.DataAttachment defuse(IrisMessageTransferDto.DataAttachment dataAttachment) {
		return new IrisMessageTransferDto.DataAttachment()
				.setDiscriminator(this.defuse(dataAttachment.getDiscriminator(), "dataAttachment.discriminator",
						IrisMessageData.DISCRIMINATOR_MAX_LENGTH))
				.setPayload(this.defuseDataPayload(dataAttachment.getPayload(), "dataAttachment.payload",
						IrisMessageData.PAYLOAD_MAX_LENGTH))
				.setDescription(this.defuse(dataAttachment.getDescription(), "dataAttachment.description",
						IrisMessageData.DESCRIPTION_MAX_LENGTH));
	}
