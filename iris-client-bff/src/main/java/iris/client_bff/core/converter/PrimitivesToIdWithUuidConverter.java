 ...
 */
@Component
public class PrimitivesToIdWithUuidConverter implements GenericConverter {
	...
	public Set<ConvertiblePair> getConvertibleTypes() {
		...
		return Set.of(//
				new ConvertiblePair(String.class, IdWithUuid.class),
				new ConvertiblePair(UUID.class, IdWithUuid.class));
	}
