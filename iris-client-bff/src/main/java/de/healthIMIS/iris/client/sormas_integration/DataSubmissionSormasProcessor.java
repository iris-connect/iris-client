 ...
 */
@Getter
abstract class DataSubmissionSormasProcessor<T> extends DataSubmissionSubProcessor<T> {
	...
	public DataSubmissionSormasProcessor(DataSubmissionDto submissionDto, Class<T> dtoType, DataRequest request,
