...
CREATE TABLE case_data_submission (
	...
	contacts_start_date datetime2 NULL,
	contacts_end_date datetime2 NULL,
	events_start_date datetime2 NULL,
	events_end_date datetime2 NULL,
...
CREATE TABLE  contact (
    ...
    first_contact_date datetime2 NULL,
    last_contact_date datetime2 NULL,
