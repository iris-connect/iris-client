...
import de.healthIMIS.sormas.client.model.CampaignFormMetaDto;
...
@Component("de.healthIMIS.sormas.client.api.CampaignFormMetaControllerApi")
	...
	public List<CampaignFormMetaDto> getAllCampaignFormMeta(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getAllCampaignFormMeta");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("since", since);
		String path = UriComponentsBuilder.fromPath("/campaignFormMeta/all/{since}").buildAndExpand(uriVariables)
				.toUriString();
