...
import de.healthIMIS.sormas.client.model.ContactCategory;
import de.healthIMIS.sormas.client.model.ContactClassification;
import de.healthIMIS.sormas.client.model.ContactIdentificationSource;
import de.healthIMIS.sormas.client.model.ContactProximity;
import de.healthIMIS.sormas.client.model.ContactRelation;
import de.healthIMIS.sormas.client.model.ContactStatus;
import de.healthIMIS.sormas.client.model.Disease;
import de.healthIMIS.sormas.client.model.DistrictReferenceDto;
import de.healthIMIS.sormas.client.model.EndOfQuarantineReason;
import de.healthIMIS.sormas.client.model.EpiDataDto;
...
import de.healthIMIS.sormas.client.model.QuarantineType;
...
import de.healthIMIS.sormas.client.model.TracingApp;
...
public class ContactDto {
	...
	@JsonProperty("multiDayContact")
	private Boolean multiDayContact = null;

	@JsonProperty("firstContactDate")
	private Instant firstContactDate = null;
	...
	public ContactDto creationDate(Instant creationDate) {
	...
	public ContactDto changeDate(Instant changeDate) {
	...
	public ContactDto reportDateTime(Instant reportDateTime) {
	...
	public ContactDto multiDayContact(Boolean multiDayContact) {
	...
	public ContactDto firstContactDate(Instant firstContactDate) {
	 ...
	 **/
	@Schema(description = "")
	public Instant getFirstContactDate() {
		return firstContactDate;
	}

	public void setFirstContactDate(Instant firstContactDate) {
		this.firstContactDate = firstContactDate;
	}

	public ContactDto lastContactDate(Instant lastContactDate) {
	...
	public ContactDto followUpUntil(Instant followUpUntil) {
	...
	public ContactDto externalToken(String externalToken) {
	...
	public ContactDto quarantineFrom(Instant quarantineFrom) {
	...
	public ContactDto quarantineTo(Instant quarantineTo) {
	...
	public ContactDto quarantineOrderedVerballyDate(Instant quarantineOrderedVerballyDate) {
	...
	public ContactDto quarantineOrderedOfficialDocumentDate(Instant quarantineOrderedOfficialDocumentDate) {
	...
	public ContactDto quarantineOfficialOrderSentDate(Instant quarantineOfficialOrderSentDate) {
	...
	public ContactDto prohibitionToWork(YesNoUnknown prohibitionToWork) {
	...
	public ContactDto prohibitionToWorkFrom(Instant prohibitionToWorkFrom) {
	...
	public ContactDto prohibitionToWorkUntil(Instant prohibitionToWorkUntil) {
	...
	public ContactDto reportingDistrict(DistrictReferenceDto reportingDistrict) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.creationDate, contactDto.creationDate)
				&& Objects.equals(this.changeDate, contactDto.changeDate) && Objects.equals(this.uuid, contactDto.uuid)
				&& Objects.equals(this.pseudonymized, contactDto.pseudonymized) && Objects.equals(this.caze, contactDto.caze)
				...
				&& Objects.equals(this.reportLat, contactDto.reportLat) && Objects.equals(this.reportLon, contactDto.reportLon)
				&& Objects.equals(this.reportLatLonAccuracy, contactDto.reportLatLonAccuracy)
				&& Objects.equals(this.region, contactDto.region) && Objects.equals(this.district, contactDto.district)
				&& Objects.equals(this.community, contactDto.community)
				&& Objects.equals(this.multiDayContact, contactDto.multiDayContact)
				&& Objects.equals(this.firstContactDate, contactDto.firstContactDate)
				...
				&& Objects.equals(this.externalToken, contactDto.externalToken)
				...
				&& Objects.equals(this.immunosuppressiveTherapyBasicDiseaseDetails,
						contactDto.immunosuppressiveTherapyBasicDiseaseDetails)
				...
				&& Objects.equals(this.quarantineTo, contactDto.quarantineTo) && Objects.equals(this.person, contactDto.person)
				...
				&& Objects.equals(this.prohibitionToWork, contactDto.prohibitionToWork)
				&& Objects.equals(this.prohibitionToWorkFrom, contactDto.prohibitionToWorkFrom)
				&& Objects.equals(this.prohibitionToWorkUntil, contactDto.prohibitionToWorkUntil)
				&& Objects.equals(this.reportingDistrict, contactDto.reportingDistrict);
	}

	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, pseudonymized, caze, caseIdExternalSystem,
				caseOrEventInformation, disease, diseaseDetails, reportDateTime, reportingUser, reportLat, reportLon,
				reportLatLonAccuracy, region, district, community, multiDayContact, firstContactDate, lastContactDate,
				contactIdentificationSource, contactIdentificationSourceDetails, tracingApp, tracingAppDetails,
				contactProximity, contactProximityDetails, contactCategory, contactClassification, contactStatus,
				followUpStatus, followUpComment, followUpUntil, overwriteFollowUpUntil, description, relationToCase,
				relationDescription, externalID, externalToken, highPriority, immunosuppressiveTherapyBasicDisease,
				immunosuppressiveTherapyBasicDiseaseDetails, careForPeopleOver60, quarantine, quarantineTypeDetails,
				quarantineFrom, quarantineTo, person, contactOfficer, resultingCase, resultingCaseUser, quarantineHelpNeeded,
				...
				quarantineHomeSupplyEnsured, quarantineHomeSupplyEnsuredComment, quarantineExtended, quarantineReduced,
				quarantineOfficialOrderSent, quarantineOfficialOrderSentDate, additionalDetails, epiData, healthConditions,
				sormasToSormasOriginInfo, ownershipHandedOver, returningTraveler, endOfQuarantineReason,
				endOfQuarantineReasonDetails, prohibitionToWork, prohibitionToWorkFrom, prohibitionToWorkUntil,
				reportingDistrict);
	}
	...
	public String toString() {
		...
		sb.append("    multiDayContact: ").append(toIndentedString(multiDayContact)).append("\n");
		...
		sb.append("    contactIdentificationSourceDetails: ").append(toIndentedString(contactIdentificationSourceDetails))
				.append("\n");
		...
		sb.append("    immunosuppressiveTherapyBasicDisease: ")
				.append(toIndentedString(immunosuppressiveTherapyBasicDisease)).append("\n");
		sb.append("    immunosuppressiveTherapyBasicDiseaseDetails: ")
				.append(toIndentedString(immunosuppressiveTherapyBasicDiseaseDetails)).append("\n");
		...
		sb.append("    quarantineOfficialOrderSentDate: ").append(toIndentedString(quarantineOfficialOrderSentDate))
				.append("\n");
