...
public enum CaseClassification {
	NOT_CLASSIFIED("NOT_CLASSIFIED"), SUSPECT("SUSPECT"), PROBABLE("PROBABLE"), CONFIRMED(
			"CONFIRMED"), CONFIRMED_NO_SYMPTOMS(
					"CONFIRMED_NO_SYMPTOMS"), CONFIRMED_UNKNOWN_SYMPTOMS("CONFIRMED_UNKNOWN_SYMPTOMS"), NO_CASE("NO_CASE");
