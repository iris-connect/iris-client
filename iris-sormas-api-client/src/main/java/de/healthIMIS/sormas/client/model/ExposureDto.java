...
public class ExposureDto {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.creationDate, exposureDto.creationDate)
				&& Objects.equals(this.changeDate, exposureDto.changeDate) && Objects.equals(this.uuid, exposureDto.uuid)
				&& Objects.equals(this.pseudonymized, exposureDto.pseudonymized)
				&& Objects.equals(this.reportingUser, exposureDto.reportingUser)
				&& Objects.equals(this.startDate, exposureDto.startDate) && Objects.equals(this.endDate, exposureDto.endDate)
				...
				&& Objects.equals(this.seatNumber, exposureDto.seatNumber) && Objects.equals(this.indoors, exposureDto.indoors)
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, pseudonymized, reportingUser, startDate, endDate, description,
				exposureType, exposureTypeDetails, location, patientExpositionRole, typeOfPlace, typeOfPlaceDetails,
				meansOfTransport, meansOfTransportDetails, connectionNumber, seatNumber, indoors, outdoors, wearingMask,
				wearingPpe, otherProtectiveMeasures, protectiveMeasuresDetails, shortDistance, longFaceToFaceContact,
				animalMarket, percutaneous, contactToBodyFluids, handlingSamples, eatingRawAnimalProducts, handlingAnimals,
				animalCondition, animalVaccinated, animalContactType, animalContactTypeDetails, bodyOfWater, waterSource,
				waterSourceDetails, contactToCase, prophylaxis, prophylaxisDate, riskArea, gatheringType, gatheringDetails,
				habitationType, habitationDetails, typeOfAnimal, typeOfAnimalDetails, physicalContactDuringPreparation,
				physicalContactWithBody, deceasedPersonIll, deceasedPersonName, deceasedPersonRelation);
	}
	...
	public String toString() {
		...
		sb.append("    physicalContactDuringPreparation: ").append(toIndentedString(physicalContactDuringPreparation))
				.append("\n");
