...
import de.healthIMIS.sormas.client.model.ReferenceDto;
...
@JsonIgnoreProperties(value = "contextReference")
public class TaskDto {
	...
	private Instant perceivedStart = null;
	...
	public TaskDto creationDate(Instant creationDate) {
	...
	public TaskDto changeDate(Instant changeDate) {
	...
	public TaskDto dueDate(Instant dueDate) {
	...
	public TaskDto suggestedStart(Instant suggestedStart) {
	...
	public TaskDto statusChangeDate(Instant statusChangeDate) {
	...
	public TaskDto perceivedStart(Instant perceivedStart) {
	 ...
	 **/
	@Schema(description = "")
	public Instant getPerceivedStart() {
		return perceivedStart;
	}

	public void setPerceivedStart(Instant perceivedStart) {
		this.perceivedStart = perceivedStart;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.creationDate, taskDto.creationDate)
				&& Objects.equals(this.changeDate, taskDto.changeDate) && Objects.equals(this.uuid, taskDto.uuid)
				&& Objects.equals(this.taskContext, taskDto.taskContext) && Objects.equals(this.caze, taskDto.caze)
				&& Objects.equals(this.event, taskDto.event) && Objects.equals(this.contact, taskDto.contact)
				&& Objects.equals(this.taskType, taskDto.taskType) && Objects.equals(this.priority, taskDto.priority)
				&& Objects.equals(this.dueDate, taskDto.dueDate) && Objects.equals(this.suggestedStart, taskDto.suggestedStart)
				...
				&& Objects.equals(this.closedLat, taskDto.closedLat) && Objects.equals(this.closedLon, taskDto.closedLon)
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, taskContext, caze, event, contact, taskType, priority, dueDate,
				suggestedStart, taskStatus, statusChangeDate, perceivedStart, creatorUser, creatorComment, assigneeUser,
				assigneeReply, closedLat, closedLon, closedLatLonAccuracy, contextReference);
	}
