...
import de.healthIMIS.sormas.client.model.SimpleTestResultType;
...
public class AdditionalTestDto {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.creationDate, additionalTestDto.creationDate)
				...
				&& Objects.equals(this.uuid, additionalTestDto.uuid) && Objects.equals(this.sample, additionalTestDto.sample)
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, sample, testDateTime, haemoglobinuria, proteinuria, hematuria,
				arterialVenousGasPH, arterialVenousGasPco2, arterialVenousGasPao2, arterialVenousGasHco3, gasOxygenTherapy,
				altSgpt, astSgot, creatinine, potassium, urea, haemoglobin, totalBilirubin, conjBilirubin, wbcCount, platelets,
				prothrombinTime, otherTestResults);
	}
