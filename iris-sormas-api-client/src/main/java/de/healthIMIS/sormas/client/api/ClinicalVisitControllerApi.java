...
import de.healthIMIS.sormas.client.model.ClinicalVisitDto;
...
@Component("de.healthIMIS.sormas.client.api.ClinicalVisitControllerApi")
	...
	public List<ClinicalVisitDto> getAllVisits(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getAllVisits");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("since", since);
		String path = UriComponentsBuilder.fromPath("/clinicalvisits/all/{since}").buildAndExpand(uriVariables)
				.toUriString();
