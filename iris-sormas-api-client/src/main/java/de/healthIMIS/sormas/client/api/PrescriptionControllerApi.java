...
import de.healthIMIS.sormas.client.model.PrescriptionDto;
...
@Component("de.healthIMIS.sormas.client.api.PrescriptionControllerApi")
	...
	public List<PrescriptionDto> getAllPrescriptions(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getAllPrescriptions");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("since", since);
		String path = UriComponentsBuilder.fromPath("/prescriptions/all/{since}").buildAndExpand(uriVariables)
				.toUriString();
