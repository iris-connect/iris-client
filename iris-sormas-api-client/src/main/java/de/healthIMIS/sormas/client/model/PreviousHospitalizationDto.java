...
public class PreviousHospitalizationDto {
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, pseudonymized, admissionDate, dischargeDate, region, district,
				community, healthFacility, healthFacilityDetails, isolated, description);
	}
