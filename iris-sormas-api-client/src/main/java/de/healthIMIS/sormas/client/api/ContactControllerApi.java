...
@Component("de.healthIMIS.sormas.client.api.ContactControllerApi")
public class ContactControllerApi {
	...
	public List<ContactDto> getAllContacts(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getAllContacts");
		}
	...
	public List<String> getDeletedUuidsSince1(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getDeletedUuidsSince1");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("since", since);
