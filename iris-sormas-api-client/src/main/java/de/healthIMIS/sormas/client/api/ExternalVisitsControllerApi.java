...
@Component("de.healthIMIS.sormas.client.api.ExternalVisitsControllerApi")
public class ExternalVisitsControllerApi {
	 ...
	 * <p>
	 * <b>0</b> - List of personUuids and their latest follow up end dates as UNIX timestamps.
	 * 
	...
	public String getLatestFollowUpEndDates(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getLatestFollowUpEndDates");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("since", since);
		String path = UriComponentsBuilder.fromPath("/visits-external/followUpEndDates/{since}")
	 ...
	 * <p>
	 * <b>0</b> - A selection of personal data, including first and last name, e-mail, phone number(s) and birth date if
	 * availablefor that person. Note that Null value fields may not be returned. If you get an unexpected result, it
	 * might help to verifyif the personUuid is existing in your system via the isValid controller.
	 * 
	...
	public String getPersonByUuid(String personUuid) throws RestClientException {
		...
		if (personUuid == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'personUuid' when calling getPersonByUuid");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("personUuid", personUuid);
		String path = UriComponentsBuilder.fromPath("/visits-external/person/{personUuid}").buildAndExpand(uriVariables)
				.toUriString();
	 ...
	 * Get API version
	 * <p>
	 * <b>0</b> - The minimal version needed for compatibility with the external ReST API of SORMAS.
	 * 
	 * @return String
	 * @throws RestClientException if an error occurs while attempting to invoke the API
	 */
	 ...
	 * <p>
	 * <b>0</b> - true a person with the given Uuid exists in SORMAS, false otherwise.
	 * 
	 * @param personUuid The personUuid parameter
	 * @return String
	 * @throws RestClientException if an error occurs while attempting to invoke the API
	...
	public String isValidPersonUuid(String personUuid) throws RestClientException {
		...
		if (personUuid == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'personUuid' when calling isValidPersonUuid");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("personUuid", personUuid);
		String path = UriComponentsBuilder.fromPath("/visits-external/person/{personUuid}/isValid")
				.buildAndExpand(uriVariables).toUriString();
	 ...
	 * <p>
	 * <b>0</b> - OK when visit was successfully saved, ERROR otherwise.
	 * 
	 ...
	 * <p>
	 * <b>0</b> - true if the status was set succesfully, false otherwise.
	 * 
	 * @param personUuid The personUuid parameter
	 * @param body status may be one of the following:&lt;br/&gt;UNREGISTERED: User has not yet sent any
	 *          state&lt;br/&gt;REGISTERED: After successful registration in SymptomJournal&lt;br/&gt;ACCEPTED: User has
	 *          accepted a confirmation&lt;br/&gt;REJECTED: User has rejected (declined) a confirmation&lt;br/&gt;DELETED:
	 *          User was deleted
	 * @return String
	 * @throws RestClientException if an error occurs while attempting to invoke the API
	 */
	public String postSymptomJournalStatus(String personUuid, String body) throws RestClientException {
		...
		if (personUuid == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'personUuid' when calling postSymptomJournalStatus");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("personUuid", personUuid);
		String path = UriComponentsBuilder.fromPath("/visits-external/person/{personUuid}/status")
				.buildAndExpand(uriVariables).toUriString();
