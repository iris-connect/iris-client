...
import de.healthIMIS.sormas.client.model.FacilityDto;
...
@Component("de.healthIMIS.sormas.client.api.FacilityControllerApi")
public class FacilityControllerApi {
	...
	public List<FacilityDto> getAllByRegion(String regionUuid, Long since) throws RestClientException {
		...
		if (regionUuid == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'regionUuid' when calling getAllByRegion");
		}
		// verify the required parameter 'since' is set
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getAllByRegion");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("regionUuid", regionUuid);
		uriVariables.put("since", since);
		String path = UriComponentsBuilder.fromPath("/facilities/region/{regionUuid}/{since}").buildAndExpand(uriVariables)
				.toUriString();
	...
	public List<FacilityDto> getAllWithoutRegion(Long since) throws RestClientException {
		...
		if (since == null) {
			throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
					"Missing the required parameter 'since' when calling getAllWithoutRegion");
		}
		// create path and map variables
		final Map<String, Object> uriVariables = new HashMap<String, Object>();
		uriVariables.put("since", since);
		String path = UriComponentsBuilder.fromPath("/facilities/general/{since}").buildAndExpand(uriVariables)
				.toUriString();
