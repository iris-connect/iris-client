...
public class DiseaseClassificationCriteriaDto {
	...
	public DiseaseClassificationCriteriaDto creationDate(Instant creationDate) {
	...
	public DiseaseClassificationCriteriaDto changeDate(Instant changeDate) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, disease, suspectCriteria, probableCriteria, confirmedCriteria,
				notACaseCriteria);
	}
