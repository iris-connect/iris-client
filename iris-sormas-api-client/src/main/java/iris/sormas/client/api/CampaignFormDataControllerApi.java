...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-06-08T06:53:38.737461+02:00[Europe/Berlin]")@Component("iris.sormas.client.api.CampaignFormDataControllerApi")
public class CampaignFormDataControllerApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<CampaignFormDataDto> getByUuids4(List<String> body) throws RestClientException {
