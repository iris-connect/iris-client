...
import iris.sormas.client.model.ActivityAsCaseDto;
import iris.sormas.client.model.ExposureDto;
...
public class EpiDataDto {
  ...
  @JsonProperty("activityAsCaseDetailsKnown")
  private YesNoUnknown activityAsCaseDetailsKnown = null;
  ...
  @JsonProperty("activitiesAsCase")
  private List<ActivityAsCaseDto> activitiesAsCase = null;
  ...
  **/
  ...
  public EpiDataDto activityAsCaseDetailsKnown(YesNoUnknown activityAsCaseDetailsKnown) {
    this.activityAsCaseDetailsKnown = activityAsCaseDetailsKnown;
    return this;
  }

   /**
   * Get activityAsCaseDetailsKnown
  ...
  **/
  ...
  public EpiDataDto activitiesAsCase(List<ActivityAsCaseDto> activitiesAsCase) {
    this.activitiesAsCase = activitiesAsCase;
    return this;
  }

  public EpiDataDto addActivitiesAsCaseItem(ActivityAsCaseDto activitiesAsCaseItem) {
    if (this.activitiesAsCase == null) {
      this.activitiesAsCase = new ArrayList<>();
    }
    this.activitiesAsCase.add(activitiesAsCaseItem);
    return this;
  }

   /**
   * Get activitiesAsCase
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.creationDate, epiDataDto.creationDate) &&
        ...
        Objects.equals(this.activityAsCaseDetailsKnown, epiDataDto.activityAsCaseDetailsKnown) &&
        ...
        Objects.equals(this.activitiesAsCase, epiDataDto.activitiesAsCase);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationDate, changeDate, uuid, pseudonymized, exposureDetailsKnown, activityAsCaseDetailsKnown, contactWithSourceCaseKnown, highTransmissionRiskArea, largeOutbreaksArea, areaInfectedAnimals, exposures, activitiesAsCase);
  }
  ...
  public String toString() {
    ...
    sb.append("    activityAsCaseDetailsKnown: ").append(toIndentedString(activityAsCaseDetailsKnown)).append("\n");
    ...
    sb.append("    activitiesAsCase: ").append(toIndentedString(activitiesAsCase)).append("\n");
    sb.append("}");
    return sb.toString();
  }
