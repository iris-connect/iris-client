...
public class InfrastructureChangeDatesDto {
  @JsonProperty("continentChangeDate")
  private Instant continentChangeDate = null;

  @JsonProperty("subcontinentChangeDate")
  private Instant subcontinentChangeDate = null;

  @JsonProperty("countryChangeDate")
  private Instant countryChangeDate = null;

  @JsonProperty("areaChangeDate")
  private Instant areaChangeDate = null;
  ...
  public InfrastructureChangeDatesDto continentChangeDate(Instant continentChangeDate) {
    this.continentChangeDate = continentChangeDate;
    return this;
  }

   /**
   * Get continentChangeDate
   * @return continentChangeDate
  **/
  @Schema(description = "")
  public Instant getContinentChangeDate() {
    return continentChangeDate;
  }

  public void setContinentChangeDate(Instant continentChangeDate) {
    this.continentChangeDate = continentChangeDate;
  }

  public InfrastructureChangeDatesDto subcontinentChangeDate(Instant subcontinentChangeDate) {
    this.subcontinentChangeDate = subcontinentChangeDate;
    return this;
  }

   /**
   * Get subcontinentChangeDate
   * @return subcontinentChangeDate
  **/
  @Schema(description = "")
  public Instant getSubcontinentChangeDate() {
    return subcontinentChangeDate;
  }

  public void setSubcontinentChangeDate(Instant subcontinentChangeDate) {
    this.subcontinentChangeDate = subcontinentChangeDate;
  }
  ...
  **/
  ...
  public InfrastructureChangeDatesDto areaChangeDate(Instant areaChangeDate) {
  ...
  **/
  @Schema(description = "")
  public Instant getAreaChangeDate() {
    return areaChangeDate;
  }

  public void setAreaChangeDate(Instant areaChangeDate) {
    this.areaChangeDate = areaChangeDate;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.continentChangeDate, infrastructureChangeDatesDto.continentChangeDate) &&
        Objects.equals(this.subcontinentChangeDate, infrastructureChangeDatesDto.subcontinentChangeDate) &&
        Objects.equals(this.countryChangeDate, infrastructureChangeDatesDto.countryChangeDate) &&
        Objects.equals(this.areaChangeDate, infrastructureChangeDatesDto.areaChangeDate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(continentChangeDate, subcontinentChangeDate, countryChangeDate, areaChangeDate, regionChangeDate, districtChangeDate, communityChangeDate, facilityChangeDate, pointOfEntryChangeDate, userChangeDate, diseaseClassificationChangeDate, diseaseConfigurationChangeDate, userRoleConfigurationChangeDate, featureConfigurationChangeDate, campaignChangeDate, campaignFormMetaChangeDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    continentChangeDate: ").append(toIndentedString(continentChangeDate)).append("\n");
    sb.append("    subcontinentChangeDate: ").append(toIndentedString(subcontinentChangeDate)).append("\n");
    sb.append("    countryChangeDate: ").append(toIndentedString(countryChangeDate)).append("\n");
    sb.append("    areaChangeDate: ").append(toIndentedString(areaChangeDate)).append("\n");
