...
public class DiseaseConfigurationDto {
  ...
  @JsonProperty("extendedClassification")
  private Boolean extendedClassification = null;

  @JsonProperty("extendedClassificationMulti")
  private Boolean extendedClassificationMulti = null;

  public DiseaseConfigurationDto creationDate(Instant creationDate) {
  ...
  **/
  ...
  public DiseaseConfigurationDto changeDate(Instant changeDate) {
  ...
  **/
  ...
  public DiseaseConfigurationDto extendedClassification(Boolean extendedClassification) {
    this.extendedClassification = extendedClassification;
    return this;
  }

   /**
   * Get extendedClassification
   * @return extendedClassification
  **/
  @Schema(description = "")
  public Boolean isExtendedClassification() {
    return extendedClassification;
  }
  ...
  public DiseaseConfigurationDto extendedClassificationMulti(Boolean extendedClassificationMulti) {
    this.extendedClassificationMulti = extendedClassificationMulti;
    return this;
  }

   /**
   * Get extendedClassificationMulti
   * @return extendedClassificationMulti
  **/
  @Schema(description = "")
  public Boolean isExtendedClassificationMulti() {
    return extendedClassificationMulti;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.creationDate, diseaseConfigurationDto.creationDate) &&
        ...
        Objects.equals(this.extendedClassification, diseaseConfigurationDto.extendedClassification) &&
        Objects.equals(this.extendedClassificationMulti, diseaseConfigurationDto.extendedClassificationMulti);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationDate, changeDate, uuid, disease, active, primaryDisease, caseBased, followUpEnabled, followUpDuration, caseFollowUpDuration, eventParticipantFollowUpDuration, extendedClassification, extendedClassificationMulti);
  }
  ...
  public String toString() {
    ...
    sb.append("    extendedClassification: ").append(toIndentedString(extendedClassification)).append("\n");
    sb.append("    extendedClassificationMulti: ").append(toIndentedString(extendedClassificationMulti)).append("\n");
    sb.append("}");
    return sb.toString();
  }
