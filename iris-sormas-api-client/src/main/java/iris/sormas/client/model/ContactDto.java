...
import iris.sormas.client.model.ContactIdentificationSource;
...
import iris.sormas.client.model.EndOfQuarantineReason;
import iris.sormas.client.model.EpiDataDto;
import iris.sormas.client.model.FollowUpStatus;
import iris.sormas.client.model.HealthConditionsDto;
...
import iris.sormas.client.model.TracingApp;
...
public class ContactDto {
  ...
  **/
  ...
  public ContactDto diseaseVariant(DiseaseVariant diseaseVariant) {
  ...
  **/
  ...
  public ContactDto vaccinationInfo(VaccinationInfoDto vaccinationInfo) {
  ...
  **/
  ...
  public ContactDto followUpStatusChangeDate(Instant followUpStatusChangeDate) {
  ...
  **/
  ...
  public ContactDto followUpStatusChangeUser(UserReferenceDto followUpStatusChangeUser) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.creationDate, contactDto.creationDate) &&
        ...
        Objects.equals(this.diseaseVariant, contactDto.diseaseVariant) &&
        ...
        Objects.equals(this.vaccinationInfo, contactDto.vaccinationInfo) &&
        Objects.equals(this.followUpStatusChangeDate, contactDto.followUpStatusChangeDate) &&
        Objects.equals(this.followUpStatusChangeUser, contactDto.followUpStatusChangeUser);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationDate, changeDate, uuid, pseudonymized, caze, caseIdExternalSystem, caseOrEventInformation, disease, diseaseDetails, diseaseVariant, reportDateTime, reportingUser, reportLat, reportLon, reportLatLonAccuracy, region, district, community, multiDayContact, firstContactDate, lastContactDate, contactIdentificationSource, contactIdentificationSourceDetails, tracingApp, tracingAppDetails, contactProximity, contactProximityDetails, contactCategory, contactClassification, contactStatus, followUpStatus, followUpComment, followUpUntil, overwriteFollowUpUntil, description, relationToCase, relationDescription, externalID, externalToken, highPriority, immunosuppressiveTherapyBasicDisease, immunosuppressiveTherapyBasicDiseaseDetails, careForPeopleOver60, quarantine, quarantineTypeDetails, quarantineFrom, quarantineTo, person, contactOfficer, resultingCase, resultingCaseUser, quarantineHelpNeeded, quarantineOrderedVerbally, quarantineOrderedOfficialDocument, quarantineOrderedVerballyDate, quarantineOrderedOfficialDocumentDate, quarantineHomePossible, quarantineHomePossibleComment, quarantineHomeSupplyEnsured, quarantineHomeSupplyEnsuredComment, quarantineExtended, quarantineReduced, quarantineOfficialOrderSent, quarantineOfficialOrderSentDate, additionalDetails, epiData, healthConditions, sormasToSormasOriginInfo, ownershipHandedOver, returningTraveler, endOfQuarantineReason, endOfQuarantineReasonDetails, prohibitionToWork, prohibitionToWorkFrom, prohibitionToWorkUntil, reportingDistrict, vaccinationInfo, followUpStatusChangeDate, followUpStatusChangeUser);
  }
