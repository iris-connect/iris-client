...
public class HospitalizationDto {
	...
	@Override
	public int hashCode() {
		return Objects.hash(creationDate, changeDate, uuid, admittedToHealthFacility, admissionDate, dischargeDate,
				isolated, isolationDate, leftAgainstAdvice, hospitalizedPreviously, previousHospitalizations, intensiveCareUnit,
				intensiveCareUnitStart, intensiveCareUnitEnd);
	}
