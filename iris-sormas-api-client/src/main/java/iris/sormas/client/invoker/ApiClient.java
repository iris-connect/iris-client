package iris.sormas.client.invoker;
...
import iris.sormas.client.invoker.auth.Authentication;
import iris.sormas.client.invoker.auth.HttpBasicAuth;
import iris.sormas.client.invoker.auth.ApiKeyAuth;
import iris.sormas.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-06-08T06:53:38.737461+02:00[Europe/Berlin]")@Component("iris.sormas.client.invoker.ApiClient")
