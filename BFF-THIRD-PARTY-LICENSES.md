...
List of third-party dependencies grouped by their license type.
    ...
    Apache License 2.0:
        ...
        * swagger-annotations (io.swagger.core.v3:swagger-annotations:2.1.10 - https://github.com/swagger-api/swagger-core/modules/swagger-annotations)
    ...
    Apache License, Version 2.0:
        ...
        * Spring Beans (org.springframework:spring-beans:5.3.9 - https://github.com/spring-projects/spring-framework)
        ...
        * spring-boot-actuator (org.springframework.boot:spring-boot-actuator:2.5.4 - https://spring.io/projects/spring-boot)
        * spring-boot-actuator-autoconfigure (org.springframework.boot:spring-boot-actuator-autoconfigure:2.5.4 - https://spring.io/projects/spring-boot)
        ...
        * spring-boot-devtools (org.springframework.boot:spring-boot-devtools:2.5.4 - https://spring.io/projects/spring-boot)
        * spring-boot-starter (org.springframework.boot:spring-boot-starter:2.5.4 - https://spring.io/projects/spring-boot)
        * spring-boot-starter-actuator (org.springframework.boot:spring-boot-starter-actuator:2.5.4 - https://spring.io/projects/spring-boot)
        ...
        * spring-boot-starter-freemarker (org.springframework.boot:spring-boot-starter-freemarker:2.5.4 - https://spring.io/projects/spring-boot)
        * spring-boot-starter-hateoas (org.springframework.boot:spring-boot-starter-hateoas:2.5.4 - https://spring.io/projects/spring-boot)
        ...
        * spring-boot-starter-mail (org.springframework.boot:spring-boot-starter-mail:2.5.4 - https://spring.io/projects/spring-boot)
        ...
        * Spring Cloud Contract Converters (org.springframework.cloud:spring-cloud-contract-converters:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-tools/spring-cloud-contract-converters)
        * Spring Cloud Contract Shaded Dependencies (org.springframework.cloud:spring-cloud-contract-shade:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-shade)
        * Spring Cloud Contract Spec (org.springframework.cloud:spring-cloud-contract-spec:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-spec)
        * Spring Cloud Contract Spec Groovy (org.springframework.cloud:spring-cloud-contract-spec-groovy:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-spec-groovy)
        * Spring Cloud Contract Spec Java (org.springframework.cloud:spring-cloud-contract-spec-java:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-spec-java)
        * Spring Cloud Contract Stub Runner (org.springframework.cloud:spring-cloud-contract-stub-runner:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-stub-runner)
        * Spring Cloud Contract Verifier (org.springframework.cloud:spring-cloud-contract-verifier:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-verifier)
        * spring-cloud-contract-wiremock (org.springframework.cloud:spring-cloud-contract-wiremock:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-wiremock)
        ...
        * Spring Cloud Contract Stub Runner Starter (org.springframework.cloud:spring-cloud-starter-contract-stub-runner:3.0.3 - https://github.com/spring-cloud/spring-cloud-contract/spring-cloud-contract-starters/spring-cloud-starter-contract-stub-runner)
        ...
        * Spring HATEOAS (org.springframework.hateoas:spring-hateoas:1.3.3 - https://github.com/spring-projects/spring-hateoas)
        ...
        * spring-security-config (org.springframework.security:spring-security-config:5.5.2 - https://spring.io/projects/spring-security)
        * spring-security-core (org.springframework.security:spring-security-core:5.5.2 - https://spring.io/projects/spring-security)
        * spring-security-crypto (org.springframework.security:spring-security-crypto:5.5.2 - https://spring.io/projects/spring-security)
        * spring-security-test (org.springframework.security:spring-security-test:5.5.2 - https://spring.io/projects/spring-security)
        * spring-security-web (org.springframework.security:spring-security-web:5.5.2 - https://spring.io/projects/spring-security)
    ...
    BSD-2-Clause:
        ...
        * PostgreSQL JDBC Driver (org.postgresql:postgresql:42.2.23 - https://jdbc.postgresql.org)
    ...
    The Apache Software License, Version 2.0:
        ...
        * micrometer-core (io.micrometer:micrometer-core:1.7.3 - https://github.com/micrometer-metrics/micrometer)
        * micrometer-registry-prometheus (io.micrometer:micrometer-registry-prometheus:1.7.3 - https://github.com/micrometer-metrics/micrometer)
