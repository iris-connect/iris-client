...
[Hier](https://github.com/iris-connect/iris-client/releases/tag/v1.6.0) finden Sie Informationen zum Release 1.6.0.

1. Laden Sie sich [das neue Release](https://github.com/iris-connect/iris-client/releases/download/v1.6.0/deployment-1.6.0.zip) herunter und entpacken Sie es in ein `Zielverzeichnis`. 
...
8. Fahren Sie die neue Version hoch.
    ...
    $ docker-compose up -d
    ```
9. Loggen Sie sich mit Ihrem Benutzer ein und gehen Sie auf `Über IRIS`. Unter Version sollten Sie die neue Version `1.6.0` vorfinden.
...
1. Laden Sie sich die [aktuelle EPS Version 0.2.7](https://github.com/iris-connect/eps/releases/tag/v0.2.7) herunter. Sie benötigen die Binaries `eps` und `proxy` für Ihre Ziel-Plattform. 

2. Stellen Sie sicher, dass `eps` und `proxy` in Ihrem Pfad liegen. 

#### IRIS Client BFF

1. Laden Sie sich die [aktuelle Version vom IRIS CLient BFF](https://github.com/iris-connect/iris-client/releases/download/v1.6.0/iris-client-bff-1.6.0.jar) herunter. 
...
1. Laden Sie sich [das neue Release](https://github.com/iris-connect/iris-client/releases/download/v1.6.0/iris-client-fe-1.6.0.zip) herunter und entpacken Sie es in ein `Zielverzeichnis`. 
...
1. Laden Sie sich [das neue Release](https://github.com/iris-connect/iris-client/releases/download/v1.6.0/stand-alone-deployment-1.6.0.zip) herunter und entpacken Sie es in ein `Zielverzeichnis`. 
