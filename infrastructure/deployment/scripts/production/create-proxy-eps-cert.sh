# Usage: create-eps-proxy-cert.sh [your signature cert private key] [your signature cert] [common name]
...
echo "[SANKey]\nsubjectAltName = URI:iris-name://${cn},URI:iris-group://private-proxies,DNS:${cn},DNS:*.${cn}.local" > $extFile
